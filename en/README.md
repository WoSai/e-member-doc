#1.Introduction
This document is used to provide membership solution on the specific customer H&M. In order to have ISV Shouqianba application work properly with H&M CRM open APIs, please read the following cooperation workflow.
